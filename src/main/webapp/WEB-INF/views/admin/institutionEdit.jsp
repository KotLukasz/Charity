...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<c:out value="/admin"/>">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form:form modelAttribute="institutionEdit" method="post">
                    <form:errors path="name"/>
                    <div class="form-group">
                        <form:textarea name="name" placeholder="Nazwa" path="name"/>
                    </div>
                    <form:errors path="description"/>
                    <div class="form-group">
                        <form:textarea cols="50" name="description" placeholder="Opis" path="description"/>
                    </div>
