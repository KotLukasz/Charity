        ...
        events() {
            ...
            this.$next.forEach(btn => {
                btn.addEventListener("click", e => {
                    ...
                    let institutionForm = $('#institutionForm').val();
                    ...
                    // if ($("#categoriesForm option:selected").html() == null) {
                    ...
                    // if ($("input[name = institutionFormName]:checked").value  == null  && this.currentStep == 3) {
                    //     alert('Proszę wybierz rodzaj instytucji');
                    //     console.log($("input[name = institutionFormName]:checked").val());
                    //     return false;
                    //     }
                        ...
                        // $('#institutionFormCompleted').text(institutionForm);
